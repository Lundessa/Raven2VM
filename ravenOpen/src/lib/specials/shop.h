...
Public functions.
============================================================================ */
int  shop_keeper(CharData *, void *, int, char *);
...
typedef struct shop_data
{
  ...
  ShopBuyT *type;       /* Which items to trade   */
...
#define NUM_SHOP_OPERATOR_STR 5
...
#define MSG_CHAR_HUNTED         "I don't trade with the likes of you."
