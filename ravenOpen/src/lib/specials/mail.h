...
/* # of days worth of rent required to send parcels */
#define PARCEL_PRICE 5
 ...
 * anyway?
 *
 * ... because 79 bytes is not enough space to fit an ObjFileElem. ;)
 *
...
#define PARCEL_BLOCK  -4

/* time in seconds a parcel can exist before being auctioned off */
#define PARCEL_LIFE     604800
