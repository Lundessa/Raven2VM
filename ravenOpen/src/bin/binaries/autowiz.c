...
struct control_rec level_params[] =
{
  ...
  {LVL_GOD, "&14Gods&00"},
  {LVL_GRGOD, "&14Greater Gods&00"},
  {LVL_IMPL, "&14Implementors&00"},
  {0, ""}
};
...
void	write_wizlist(FILE *out, int minlev, int maxlev)
{
   ...
   fprintf(out,
       "****************************************************************************\n"
       "  Below is a list of the only people you're FORCED to love and cherish in   \n"
       "  this domain. They are the IMMortal's of RavenMUD!                        \n"
       "  These folk should be your first stop off point if you run into a problem  \n"
       "  or question during your adventures.                                       \n\n");
   ...
   for (curr_level = levels; curr_level; curr_level = curr_level->next) {
	 ...
	 if (curr_level->params->level <= COL_LEVEL)
      ...
      fprintf(out,
       "  Special Thanks to our &08Founder&00: Digger                                     \n"
       "  &11Raven Contributors&00: Namtar, Elminster, Death, Arson, Fenrir, Synister,    \n"
       "  Acibaldes, Sammael, Vex, Craklyn, Imhotep, Baal, Hasana, Jester, Corwin,  \n"
       "  Memnoch, Pax, Sanji, Tarin, Tyr, Kailis, Judas, Smythe, Hippocrates,      \n"
       "  Maelstrom, Wiley, Goth, Cicero, Ynnek, Slush, Sparhawk, Liam, Belial,     \n"
       "  Kaidon, Yun, Elendil, Sauron, Akkar, Kellory, Ragnarok, Ngatai, Kord,     \n"
       "  Kurse, Mathayus, Mirt, Maestro, Swift, Marduk, and Jamar.                 \n"
       "                                                                            \n"
